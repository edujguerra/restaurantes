...
DELETE from tb_tipocozinha;
-- DELETE from restaurantes.tb_cliente;
DELETE from tb_cliente;

INSERT INTO tb_tipocozinha (id_tipo_cozinha, ds_tipo) VALUES (1, 'LANCHES');
INSERT INTO tb_tipocozinha (id_tipo_cozinha, ds_tipo) VALUES (2, 'PIZZAS');
INSERT INTO tb_tipocozinha (id_tipo_cozinha, ds_tipo) VALUES (3, 'MASSAS');
INSERT INTO tb_tipocozinha (id_tipo_cozinha, ds_tipo) VALUES (4, 'BIFES');
INSERT INTO tb_tipocozinha (id_tipo_cozinha, ds_tipo) VALUES (5, 'PRATO FEITO');
...
--INSERT INTO restaurantes.tb_avaliacao
...
INSERT INTO tb_reserva (id_reserva, data_reserva, hr_final, hr_inicio, numero_pessoas, cliente_id_cliente, restaurante_id_restaurante)
VALUES (1, '2024-03-20', '21', '20', 8, 1, 2);
INSERT INTO tb_reserva (id_reserva, data_reserva, hr_final, hr_inicio, numero_pessoas, cliente_id_cliente, restaurante_id_restaurante)
VALUES (2, '2024-03-20', '21', '20', 14, 2, 2);
INSERT INTO tb_reserva (id_reserva, data_reserva, hr_final, hr_inicio, numero_pessoas, cliente_id_cliente, restaurante_id_restaurante)
